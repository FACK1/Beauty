...
const result = [ { brand: 'colourpop',
    name: 'No Filter Foundation',
    image:
     'https://cdn.shopify.com/s/files/1/1338/0845/products/foundations-lineup_800x1200.jpg',
    price: '12.0',
    currency: '$' },
  { brand: 'deciem',
    name: 'Serum Foundation',
    image:
     'https://3bc01d2807fb1bc0d25c-a86d2521f1af8989841b9619f5314be5.ssl.cf1.rackcdn.com/products/market-img/rdn-serum-foundation-30-r-30ml.png',
    price: '6.7',
    currency: '$' },
  { brand: 'deciem',
    name: 'Coverage Foundation',
    image:
     'https://3bc01d2807fb1bc0d25c-a86d2521f1af8989841b9619f5314be5.ssl.cf1.rackcdn.com/products/market-img/rdn-coverage-foundation-33-n-30ml.png',
    price: '6.9',
    currency: '$' },
  { brand: 'w3llpeople',
